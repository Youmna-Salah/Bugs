...
public class SlideBarAdapter extends RecyclerView.Adapter<SlideBarAdapter.ViewHolder> {
    /**
    ...
    SlideBarAdapter(String titles[],int icons[],String name, int profile,Context context){
        this.titles = titles;
        this.icons = icons;
        this.name = name;
    ...
    @Override
    public SlideBarAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
     ...
     */
    @Override
    public void onBindViewHolder( SlideBarAdapter.ViewHolder holder, int position) {
